...
const verstuur = () => {
    let txtinvoer = document.getElementById("invoer").value;
    console.log(maakMetSpaties(txtinvoer));
}

const maakMetSpaties = (txtinvoer) => {
    txtinvoer = txtinvoer.trim().replaceAll(' ', '').split('');
    let output = '';
